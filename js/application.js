  ...
  */
  ...
  MEME.MemeModel = Backbone.Model.extend({
    defaults: {
      ...
      downloadName: 'Sterlite',
      fontColor: 'white',
      fontFamily: 'Montserrat',
      fontFamilyOpts: ['Montserrat', 'Helvetica Neue', 'Comic Sans MS'],
      fontSize: 25,
      fontSizeOpts: [30, 36],
      headlineText: 'Jane',
      height: 500,
  ...
  MEME.MemeCanvasView = Backbone.View.extend({
    ...
    render: function() {
      ...
      function renderHeadline(ctx) {
        var maxWidth = Math.round(d.width * 1);
        var x = padding;
        var y = padding;
        ...
        ctx.textAlign = 'left';
        x = d.width / 15;
        y = d.height - d.height / 2.7;
        maxWidth = d.width - d.width / 2;
        
  
        var caption = 'I\'m ' + d.headlineText + '.I give the Sterling Touch' + '.I belong to the Give network' + '.Join Me.' + '.#LeavingALegacy';
        
        var upperCaption = caption.toUpperCase();
      ...
      function renderWatermark(ctx) {
        ...
        if (bh && bw) {
          ...
          ctx.drawImage(m.watermark, 0, 0, bw, bh, d.width-padding-tw/1.2, d.height-padding-th/1.2, tw, th);
          ctx.globalAlpha = 1;
        }
      }
      ...
      this.$('#meme-download').attr({
        'href': data,
        'download': (d.downloadName || 'sterlite') + '.png'
      });
  ...
  */
  ...
  MEME.MemeEditorView = Backbone.View.extend({
    ...
    render: function() {
      ...
      this.$('#headline2').val(d.headline2Text);
      ...
      this.$('#file-input').val(d.fileInput);
    ...
    onHeadline2: function() {
      this.model.set('headline2Text', this.$('#headline2').val());
    },
    ...
    onFileSelect:function(t){
        var e=t.target,n=this.model;
        e&&(n.loadBackground(e.files[0]),
        n.background.onload=function(){n.set("imageSrc",n.background.src)})},
